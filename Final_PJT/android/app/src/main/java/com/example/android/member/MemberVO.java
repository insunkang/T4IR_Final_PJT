package com.example.android.member;
...
public class MemberVO {
    ...
    public MemberVO(String member_id, String member_pass, String member_ceim_state, String member_car_state, String member_family) {
        this.member_id = member_id;
        this.member_pass = member_pass;
        this.member_ceim_state = member_ceim_state;
        this.member_car_state = member_car_state;
